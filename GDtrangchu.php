...
<body>
    ...
    <div class="header">
        ...
        <div class="name">TRANG CHỦ THI THỬ LÁI XE A1</div>
        <div>
            <?php
            session_start();
            ...
            ?>
				...
				<button style="background-color: blue;" onclick="window.location.href='GDdangky.php'">Đăng ký</button>
            <?php
            } else {
                $loggedIn = true;
            ?>
    ...
    <div class="menu-container">
        <div class="menu">
            <?php if ($loggedIn) { ?>
                <form action="GDchonde.php" method="POST">
                    <button type="submit" class="btn-tt">Thi thử</button>
                </form>
            <?php } else { ?>
                <div>
